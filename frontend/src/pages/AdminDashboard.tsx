                  ...
                  filteredOrders.map((order) => (
                    <button
                      ...
                      className={`w-full text-left p-4 hover:bg-gray-50 transition-colors ${
                        selectedOrder?.id === order.id ? 'bg-purple-50 border-l-4 border-purple-500' : ''
                      }`}
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full p-2 border rounded-lg h-24 focus:ring-2 focus:ring-purple-500 outline-none"
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-sm text-gray-600 mb-6">
                現在のプラン: <span className="font-bold uppercase text-purple-600">{currentPlan}</span>
              </p>
