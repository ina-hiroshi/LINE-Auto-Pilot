        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <section className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
              ...
              <p className="text-slate-600">ユーザーは，管理画面の「設定」→「プラン」タブからの削除操作により，いつでも本サービスから退会できるものとします。</p>
              <p className="text-slate-600 mt-3">退会にともない，アカウント情報および店舗に関するデータは削除され，ご契約中の有料プランは無料お試し期間中のものを含め解約されます。削除されたデータの復旧および利用期間に応じた日割りでの返金は行いません。ただし，法令にもとづき保存が義務づけられている取引記録はこの限りではありません。</p>
            </section>
